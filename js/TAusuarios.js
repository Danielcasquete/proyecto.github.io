...
function traerInformacion(){
    ...
    success : function(respuesta) {
		...
		$("#table-box").empty();
        let miTabla = '<table class="table"><thead><tr><th scope="col">id</th><th scope="col">Identificacion</th><th scope="col">Nombre</th><th scope="col">Direccion</th><th scope="col">Celular</th><th scope="col">Correo</th><th scope="col">Contraseña</th><th scope="col">Zona</th><th scope="col">Tipo</th></tr></thead><tbody>';
		for (i=0; i<respuesta.length; i++){
			miTabla += '<tr>';
            miTabla += '<th scope="row">'+respuesta[i].id+'</th>';       
