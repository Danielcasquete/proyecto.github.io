...
function registrar(){
    ...
    && ($("#username").val() != "")  && ($("#identiuser").val() != "")
    && ($("#divbirthtDay").val() != "")  && ($("#divmonthBirthtDay").val() != "")
    ...
    let datos={
        ...
        name : $("#username").val(),
        birthtDay : $("#divbirthtDay").val(),
        monthBirthtDay : $("#divmonthBirthtDay").val(),
...
function validarusuariodb(){
    ...
    $.ajax({
        //url del servicio
        url: "http://localhost/api/user/emailexist/"+ email,
        //tipo de peticion
        type: 'GET',
        async: false,
        //tipo de contenido
