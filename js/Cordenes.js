...
function traerInformacion(){
    ...
    $('#login4').hide();
	$.ajax({    
    url : 'http://144.22.228.170/api/order/salesman/'+usuariojscript.id,
    type : 'GET',
    dataType : 'json',
...
function traerInformacionporestado(){
	...
	$.ajax({    
    url : 'http://144.22.228.170/api/order/state/'+zonasearch+'/'+usuariojscript.id,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function traerInformacionporfecha(){
    ...
    if(fechasearch == ""){
        urlenvi = 'http://144.22.228.170/api/order/salesman/'+usuariojscript.id;

    }else{
        urlenvi = 'http://144.22.228.170/api/order/date/'+fechasearch+'/'+usuariojscript.id;
    }
